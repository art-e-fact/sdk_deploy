...
It samples several short cross-sections across the robot heading, searches for the left and right rail peaks near the expected gauge, and fits a centerline through the detected slice midpoints.
...
- `gauge_tolerance` (`0.40`): search half-width around each expected rail position
